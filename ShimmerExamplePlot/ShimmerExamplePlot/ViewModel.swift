...
class ViewModel: NSObject, ObservableObject {
    ...
    func sendS3RInfoMemConfigUpdate() async {
        ...
        if(shimmer3Protocol?.altMagSensor.sensorEnabled != false){
                    var mag = shimmer3Protocol?.altMagSensor
                    infomem = mag?.updateInfoMem3RAltMagRange(infomem: infomem!, range: AltMagSensor.Range3R.fromValue(UInt8(altMagRange3RIndex))!)
        }
        if(shimmer3Protocol?.gyroSensor.sensorEnabled != false){
    ...
    func sendInfoMemS3RAltMag() async{
        let infomaltmag:[UInt8] = [
            ...
            ,
        ...
        await shimmer3Protocol?.writeShimmer3InfoMem(infoMem: infomaltmag)
        refreshUISettings()
    }
    
    func sendInfoMemS3RLNAccel() async{
        let infomlnacc:[UInt8] = [
            ,
    ...
    func sendInfoMemS3RGyro() async{
        let infomgyro:[UInt8] = [
            ]
    ...
    func sendInfoMemS3RWRAccel() async{
        let infomwracc:[UInt8] = [
            ...
            
             ]
        await shimmer3Protocol?.writeShimmer3InfoMem(infoMem: infomwracc)
        refreshUISettings()
