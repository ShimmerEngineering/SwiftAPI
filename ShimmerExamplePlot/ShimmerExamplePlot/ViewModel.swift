...
class ViewModel: NSObject, ObservableObject {
    ...
    func enableS3RAltMag() async{
        await shimmer3Protocol?.sendSetSensorsCommand(sensorBitmap: Shimmer3Protocol.SensorBitmapShimmer3.SENSOR_ALT_MAG.rawValue);
        refreshUISettings()
    }
    
    func enableS3RHighGAccel() async{
        await shimmer3Protocol?.sendSetSensorsCommand(sensorBitmap: Shimmer3Protocol.SensorBitmapShimmer3.SENSOR_HIGHG_ACCEL.rawValue);
        refreshUISettings()
    }
    ...
    func enableS3RGyro() async{
        await shimmer3Protocol?.sendSetSensorsCommand(sensorBitmap: Shimmer3Protocol.SensorBitmapShimmer3.SENSOR_GYRO.rawValue);
        refreshUISettings()
    }
